/**
 * 
 * Modified by Brendon C on 2008-01-08
 * For Aphex JS Toolkit
 * http://toolkit.aphexcreations.net/
 * 
 */
	...
	$.extend($.ui.slider.prototype, {
		...
		moveTo: function(value,scale,changeslide,p) {	// renamed from goto to moveTo as goto is reserved javascript word
			...
			if(!changeslide && this.interaction.pickValue != this.interaction.curValue && !p) {
				$(this.element).triggerHandler("slidechange", [false, this.prepareCallbackObj(this.interaction)], o.change);
			}
			if(changeslide) {
				$(this.element).triggerHandler("slide", [false, this.prepareCallbackObj(this.interaction)], o.slide);
			}
